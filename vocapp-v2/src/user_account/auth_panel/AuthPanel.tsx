...
function AuthPanel({
    ...
    return (
        <div className={`auth-panel${authPanelClassName ? ` ${authPanelClassName}` : ''}`}>
            <h2 className={`auth-panel-title${authTitleClassName ? ` ${authTitleClassName}` : ''}`}>
                {authTitle}
            </h2>
            <p className={`login-subtitle${authSubtitleClassName ? ` ${authSubtitleClassName}` : ''}`}>
                {authSubtitle}
            </p>

            <form
                className={`login-form${authFormClassName ? ` ${authFormClassName}` : ''}`}
            ...
            <button className={`login-button${submitButtonClassName ? ` ${submitButtonClassName}` : ''}`}>
                {submitButtonText}
            </button>
            <button
                className={`secondary-button${secondaryButtonClassName ? ` ${secondaryButtonClassName}` : ''}`}
                onClick={onToggle}
            >
                {secondaryButtonText}
            </button>
